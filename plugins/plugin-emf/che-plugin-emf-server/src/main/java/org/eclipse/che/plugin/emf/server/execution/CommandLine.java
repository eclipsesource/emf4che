 ...
 *******************************************************************************/
package org.eclipse.che.plugin.emf.server.execution;
...
/**
 * Manages command line options and create native OS process.
 * Also manages creating {@link Process} object by {@link CommandLine#createProcess()}.
 * All options represented as-is, without any escaping or encoding.
 *
